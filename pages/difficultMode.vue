...
const useLocalDifficult = score.localDifficult
...
class Game{
  ...
  export default{
   ...
   methods: {
    ...
    getStorage() {
      return JSON.parse(localStorage.getItem("scoreDifficult"))
    },
    setStorage(useLocalDifficult){
      localStorage.setItem("scoreDifficult", JSON.stringify(useLocalDifficult))
    },
    saveStorage(){
      let storageScore = this.getStorage()
      storageScore = JSON.parse(JSON.stringify(useLocalDifficult))
    ...
    score(){
          ...
          score.pushSecondsDifficult(allSeconds)
      },
...
<template>
      ...
      <div 
          ...
          <div class="flex items-center justify-center">
              <UiButton class="btn" @click="openHardGame">Start</UiButton>
              <UiButton class="btn2" @click="restartGameHard">Restart</UiButton>
